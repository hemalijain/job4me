...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post employments_url, params: { employment: { ctc: @employment.ctc, current_company: @employment.current_company, ectc: @employment.ectc, name: @employment.name, relevent_experience: @employment.relevent_experience, string,: @employment.string,, total_experience: @employment.total_experience } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { ctc: @employment.ctc, current_company: @employment.current_company, ectc: @employment.ectc, name: @employment.name, relevent_experience: @employment.relevent_experience, string,: @employment.string,, total_experience: @employment.total_experience } }
